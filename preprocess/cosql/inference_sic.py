...
from preprocess.cosql.sic_utils import MyClassifier, ColumnAndTableClassifierDataset, auc_metric, roc_auc_score, cls_metric
...
def generate_eval_ranked_dataset(args, dataset):
    ...
    print("TRS: {}".format(sum(table_coverage_state_list) / len(table_coverage_state_list)))
    print("CRS: {}".format(sum(column_coverage_state_list) / len(column_coverage_state_list)))
    return output_dataset
